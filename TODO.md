...
| 记忆长廊日历视图 | 🚧 P1B 完成 | 周历列表 + 月历色块 + 当天详情 + 健康 chip 保底上线（旧洞察/明细并存，星图暂留）。P1C 清理星图/升主线 / P2 网格+筛选 / P3 完整健康图层 待开发（方案见 `docs/_common/plans/2026-07-05-Holo记忆长廊日历视图（周历+月历）方案.md`） |
