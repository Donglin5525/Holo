...
nonisolated enum IntentDescriptorRegistry {
    ...
    static let descriptors: [IntentDescriptor] = [
        IntentDescriptor(ids: ["record_expense"], summary: "记支出。填 amount、note、categoryCandidate；明确或相对日期填 transactionDate（YYYY-MM-DD），可选 normalizedCategoryCandidate/semanticCategoryHint；用户明确提到进行中项目名时填 projectCandidate（照抄项目名，未提及不填）。工资+金额走 record_income。", requiredFields: ["amount"], examples: ["\"昨天麦当劳35\" → intent: \"record_expense\", extractedData: { amount: \"35\", note: \"麦当劳\", categoryCandidate: \"麦当劳\", transactionDate: \"2026-06-02\", normalizedCategoryCandidate: \"快餐\", semanticCategoryHint: \"餐饮\" }", "\"给爷爷买了两百块的彩票\" → intent: \"record_expense\", extractedData: { amount: \"200\", note: \"给爷爷买彩票\", categoryCandidate: \"给爷爷买彩票\", semanticCategoryHint: \"人情\" }", "\"奶茶22，算装修的\" → intent: \"record_expense\", extractedData: { amount: \"22\", note: \"奶茶\", categoryCandidate: \"奶茶\", normalizedCategoryCandidate: \"饮品\", semanticCategoryHint: \"餐饮\", projectCandidate: \"装修\" }"]),
