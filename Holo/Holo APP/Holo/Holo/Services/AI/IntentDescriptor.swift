...
nonisolated enum IntentDescriptorRegistry {
    ...
    static let descriptors: [IntentDescriptor] = [
        ...
        IntentDescriptor(ids: ["update_goal_field"], summary: "改目标字段。填 goalTitle、field（title/deadline/summary/desiredOutcome/motivation）、value。", requiredFields: ["goalTitle","field","value"], examples: ["\"把英语目标截止日期改成年底\" → intent: \"update_goal_field\", extractedData: { goalTitle: \"英语\", field: \"deadline\", value: \"年底\" }"]),
