    ...
    static var steps: [CoachMarkStep] {
        [
            CoachMarkStep(
                ...
                title: String(localized: "生活的五个入口"),
                message: String(localized: "任务、财务、习惯、健康、想法，点开就能记录。长按图标还可以拖动，把最常用的放到顺手的位置。")
            ),
            CoachMarkStep(
            ...
            CoachMarkStep(
                ...
                title: String(localized: "随时找 Holo 聊聊"),
                message: String(localized: "不用想“该去哪记”——直接告诉 Holo 一件事，比如“午饭花了 35 元”，它会帮你记好。右边是记忆长廊，你的记录会自动汇成那里。"),
