...
enum LegalHTMLTemplates {
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    <ul>
        ...
        <li><strong>想法记录</strong>：您创建的想法、标签和引用，存储在您的设备本地和您的 iCloud 中。</li>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr><td>想法数据</td><td>想法记录、标签与引用管理</td></tr>
    ...
    <h2>三、服务内容</h2>
    <ol>
        <li><strong>核心功能</strong>：本应用提供个人数据管理工具，包括财务记录、习惯追踪、待办管理、健康数据展示和想法记录等。</li>
