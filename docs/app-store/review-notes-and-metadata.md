...
推荐关键词字段（2026-09-07 七麦复核版，实测 98 字符）：

账本,收支,账单,消费,预算,收入,支出,账户,清单,事项,计划,目标,自律,打卡,备忘录,灵感,想法,情绪,手账,记录,钱迹,鲨鱼,口袋,松鼠,时光序,倒数日,倒计时,小习惯,小鹿,悦,贷,周周

说明：如果使用推荐 App 名称和副标题，关键词字段不要再重复“记账、待办、习惯、日历、复盘、笔记、健康、AI、助手、整理”。

本版依据（七麦搜索指数，≥4605 为有真实搜索量，2026-09-07 实测）：

- 新增竞品词根：钱迹 6351、鲨鱼 6616、口袋 7371（组合词“口袋记账”7369）、松鼠 5176（“松鼠记账”5176）、时光序 7364、倒数日 7799、倒计时 7364、小习惯 7366。
- 新增通用词：情绪 6398、手账 5704；保留「记录」连接字根（消费记录 6583、语音记录助手 7112 等组合依赖它）。
- 保留已验证的借字词根：贷（消费贷 6583）、周周（周周消费 4606）、悦（悦习惯 4644）、小鹿（小鹿记账 4574）。
- 剔除零流量长尾词根：生活记录、效率、时间管理、个人管理、每日记录、周计划、月总结、心情、睡眠、运动、分类、提醒（其组合在覆盖数据中指数均为 0，只制造“名义覆盖”）。
- Timi 测得 6438，但搜索结果被无关 AI 应用占据、流量不是记账品牌搜索，且占 5 字符，故不加。
- 随手记、滴答清单、Things、Forest 等头部品牌词仍不加：品牌方占首位，小体量应用进不了前 50。
